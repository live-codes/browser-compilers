var elksvg=(()=>{var C=Object.create;var a=Object.defineProperty;var E=Object.getOwnPropertyDescriptor;var L=Object.getOwnPropertyNames;var $=Object.getPrototypeOf,I=Object.prototype.hasOwnProperty;var g=t=>a(t,"__esModule",{value:!0});var w=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),T=(t,e)=>{g(t);for(var r in e)a(t,r,{get:e[r],enumerable:!0})},k=(t,e,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of L(e))!I.call(t,i)&&i!=="default"&&a(t,i,{get:()=>e[i],enumerable:!(r=E(e,i))||r.enumerable});return t},_=t=>k(g(a(t!=null?C($(t)):{},"default",t&&t.__esModule&&"default"in t?{get:()=>t.default,enumerable:!0}:{value:t,enumerable:!0})),t);var x=w((y,p)=>{"use strict";var o=class{constructor(){this.INDENTATION=2}indent(e){return" ".repeat(this.INDENTATION*e)}},d=class extends o{constructor(e){super();this.content=this._stripCommonIndentation(e)}_stripCommonIndentation(e){var r=0,i=!0;for(let s of e)if(!(i&&s==`
...
`)}},u=class extends o{constructor(e){super();this.child=e}render(e=0){var r=[];return r.push(`${this.indent(e)}<![CDATA[
...
`);s.push(this.indent(e)),s.push(`</${this.tagName}>`)}else s.push(" />");return s.join("")}};undefined===p&&console.log(new h("svg",{version:"1.1",xmlns:"http://www.w3.org/2000/svg",width:104,height:104},[new h("defs",{},[new h("style",{type:"text/css"},[new u(new d(`
              rect {
                opacity: 0.8;
                fill: #6094CC;
                stroke-width: 1;
